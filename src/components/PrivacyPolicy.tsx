...
export const PrivacyPolicy = () => {
    ...
    const [analyticsAllowed, setAnalyticsAllowed] = useState(getAnalyticsConsent());
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-[#0B0F19] text-slate-900 dark:text-slate-100 transition-colors duration-500">
            <div className="container mx-auto max-w-3xl px-6 pb-16 pt-[calc(1.5rem+env(safe-area-inset-top))]">
                ...
                <div className="mb-12 flex flex-col gap-3 rounded-2xl border border-emerald-500/20 bg-emerald-500/5 p-4 sm:flex-row sm:items-center sm:justify-between">
                    <p className="text-sm text-slate-600 dark:text-slate-300">Optional product analytics is currently <strong>{analyticsAllowed ? 'enabled' : 'disabled'}</strong>.</p>
                    <button type="button" onClick={toggleAnalytics} className="shrink-0 rounded-lg bg-emerald-600 px-4 py-2 text-xs font-bold text-white hover:bg-emerald-700">{analyticsAllowed ? 'Disable analytics' : 'Enable analytics'}</button>
                </div>
                ...
                <div className="space-y-8 text-slate-600 dark:text-slate-400 leading-relaxed">
                    <section>
                        ...
                        <p>
                            CityBikes Premium ("we", "us", "the app") is a mapping application that helps you locate
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-6 space-y-2">
                            ...
                            <li><strong>Optional usage analytics:</strong> If you opt in, Swetrix receives anonymous page views and product events to help us improve the app. We do not send your location, search text, contact messages, or personal identity.</li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="space-y-4 text-sm">
                            ...
                            <div className="bg-white dark:bg-slate-900/50 rounded-xl p-4 border border-slate-200 dark:border-slate-700">
                                <div className="font-bold text-slate-800 dark:text-white">Swetrix</div>
                                <div className="text-slate-500">Optional privacy-focused analytics for page views and anonymous product events. Analytics is loaded only after consent and does not receive location, free-text searches, contact content, or user identifiers.</div>
                            </div>
                        </div>
                    ...
                    <section>
                        ...
                        <p>
                            ...
                            Favourites, language, theme, and analytics consent preferences are retained on your device and are cleared when
                    ...
                    <section>
                        ...
                        <p>You can revoke location permission in your device settings at any time. You can decline analytics when prompted or clear the analytics preference in the app data. Clearing app data removes all locally stored favourites and preferences.</p>
                    </section>
